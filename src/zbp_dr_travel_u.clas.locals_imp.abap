CLASS lhc_Travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    ...
    TYPES : tt_failed   TYPE TABLE FOR FAILED EARLY zdr_i_travel_u\\Travel,
            tt_reported TYPE TABLE FOR REPORTED EARLY zdr_i_travel_u\\Travel.
    ...
    TYPES : tt_booking_failed   TYPE TABLE FOR FAILED  zdr_i_booking_u,
            tt_booking_reported TYPE TABLE FOR REPORTED  zdr_i_booking_u.
    METHODS map_messages_assoc_to_booking
      IMPORTING
        cid          TYPE abp_behv_cid OPTIONAL
        ls_dependend TYPE abap_bool DEFAULT abap_false
        messages     TYPE /dmo/t_message
      EXPORTING
        failed_added TYPE abap_boolean
      CHANGING
...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD get_instance_features.
     READ ENTITIES OF zdr_i_travel_u IN LOCAL MODE
       ENTITY Travel
